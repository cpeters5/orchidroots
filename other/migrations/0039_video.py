...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('other', '0038_accepted_common_name_search'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(db_column='family', on_delete=django.db.models.deletion.DO_NOTHING, related_name='othvideofamily', to='core.family')),

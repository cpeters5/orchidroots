...
class Distribution(models.Model):
    pid = models.ForeignKey(Species, on_delete=models.DO_NOTHING,db_column='pid', default='', related_name='othdist_pid')
...
class Video(models.Model):
    pid = models.ForeignKey(Species, null=False, db_column='pid', related_name='othvideopid',on_delete=models.DO_NOTHING)
    binomial = models.CharField(max_length=500, null=True, blank=True)
    author = models.ForeignKey(Photographer, db_column='author', related_name='othvideoauthor', on_delete=models.DO_NOTHING)
    credit_to = models.CharField(max_length=100, null=True, blank=True)
    name = models.CharField(max_length=100, null=True, blank=True)
    status = models.CharField(max_length=10, default='TBD')
    quality = models.IntegerField(choices=QUALITY, default=3,)
    ...
    family = models.ForeignKey(Family, db_column='family', related_name='othvideofamily', on_delete=models.DO_NOTHING)
    download_date = models.DateField(null=True, blank=True)
    user_id = models.ForeignKey(User, db_column='user_id',related_name='othvideouser_id', null=True, blank=True,on_delete=models.DO_NOTHING)
    approved_by = models.ForeignKey(User, db_column='approved_by', related_name='othvideoapproved_by', null=True, blank=True,on_delete=models.DO_NOTHING)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)

...
class Genus(models.Model):
    ...
    family = models.ForeignKey(Family, null=True, blank=True, db_column='family', related_name='anifamily', on_delete=models.DO_NOTHING)
    subfamily = models.ForeignKey(Subfamily, null=True, blank=True, db_column='subfamily', related_name='anisubfamily', on_delete=models.DO_NOTHING)
    tribe = models.ForeignKey(Tribe, null=True, blank=True, db_column='tribe', related_name='anitribe', on_delete=models.DO_NOTHING)
    subtribe = models.ForeignKey(Subtribe, null=True, blank=True, db_column='subtribe', related_name='anisubtribe', on_delete=models.DO_NOTHING)
...
class Species(models.Model):
    ...
    def grex(self):
        name = str(self.genus) + ' ' + str(self.species)
        if self.infraspr:
...
class Hybrid(models.Model):
    ...
    seed_gen = models.ForeignKey(Genus, db_column='seedgen', related_name='aniseedgen', null=True,
                                 on_delete=models.DO_NOTHING)
    ...
    user_id = models.ForeignKey(User, db_column='user_id', related_name='aniuser_id1', null=True, blank=True, on_delete=models.DO_NOTHING)
...
class AncestorDescendant(models.Model):
    ...
    did = models.ForeignKey(Hybrid, null=False, db_column='did', related_name='anidid',on_delete=models.CASCADE)
    aid = models.ForeignKey(Species, null=False, db_column='aid', related_name='aniaid',on_delete=models.CASCADE)
...
class Synonym(models.Model):
    spid = models.OneToOneField(
        Species,
        related_name='anispid',
        db_column='spid',
        on_delete=models.CASCADE,
        primary_key=True)
    acc = models.ForeignKey(Species, verbose_name='accepted genus', related_name='aniaccid', on_delete=models.CASCADE)
    comment = models.TextField(null=True, blank=True)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)
...
class Video(models.Model):
    ...
    family = models.ForeignKey(Family, db_column='family', related_name='anivideofamily', on_delete=models.DO_NOTHING)
    download_date = models.DateField(null=True, blank=True)
    user_id = models.ForeignKey(User, db_column='user_id',related_name='anivideouser_id', null=True, blank=True,on_delete=models.DO_NOTHING)
    approved_by = models.ForeignKey(User, db_column='approved_by', related_name='anivideoapproved_by', null=True, blank=True,on_delete=models.DO_NOTHING)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)

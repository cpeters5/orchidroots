...
class Genus(models.Model):
    ...
    family = models.ForeignKey(Family, null=True, blank=True, db_column='family', related_name='avefamily', on_delete=models.DO_NOTHING)
    subfamily = models.ForeignKey(Subfamily, null=True, blank=True, db_column='subfamily', related_name='avesubfamily', on_delete=models.DO_NOTHING)
    tribe = models.ForeignKey(Tribe, null=True, blank=True, db_column='tribe', related_name='avetribe', on_delete=models.DO_NOTHING)
    subtribe = models.ForeignKey(Subtribe, null=True, blank=True, db_column='subtribe', related_name='avesubtribe', on_delete=models.DO_NOTHING)
...
class Species(models.Model):
    ...
    family = models.ForeignKey(Family, null=True, db_column='family', related_name='spcavefamily', on_delete=models.DO_NOTHING)
    # citation = models.CharField(max_length=200)
    is_migratory = models.BooleanField(null=True, default=False)
    is_carnivorous = models.BooleanField(null=True, default=False)
    is_parasitic = models.BooleanField(null=True, default=False)
    # cit_status = models.CharField(max_length=20, null=True)
    ...
    gen = models.ForeignKey(Genus, db_column='gen', related_name='avepoolgen', default=0, on_delete=models.DO_NOTHING)
    notepad = models.CharField(max_length=500, default='')
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)
    ...
    def sourceurl(self):
        if self.source == 'AlgaeBase' and self.orig_pid:
            ...
            return "https://avibase.ca/" + self.orig_pid
        else:
            return None
...
class Accepted(models.Model):
    ...
    #         return img
    #     else:
    #         img = SpcImages.objects.filter(Q(pid=self.pid) | Q(pid__in=spid_list)).filter(
    #             image_file__isnull=False).order_by('quality', '-rank', '?')
    #         if img.count() > 0:
    #             img = img[0:1][0]
    #             return img
    #     return None
...
class Hybrid(models.Model):
    ...
    seed_gen = models.ForeignKey(Genus, db_column='seedgen', related_name='aveseedgen', null=True,
                                 on_delete=models.DO_NOTHING)
    ...
    user_id = models.ForeignKey(User, db_column='user_id', related_name='aveuser_id1', null=True, blank=True, on_delete=models.DO_NOTHING)
...
class AncestorDescendant(models.Model):
    ...
    did = models.ForeignKey(Hybrid, null=False, db_column='did', related_name='avedid',on_delete=models.CASCADE)
    aid = models.ForeignKey(Species, null=False, db_column='aid', related_name='aveaid',on_delete=models.CASCADE)
...
class Distribution(models.Model):
    pid = models.ForeignKey(Species, on_delete=models.DO_NOTHING,db_column='pid', default='', related_name='avedist_pid')
...
class Synonym(models.Model):
    spid = models.OneToOneField(
        Species,
        related_name='avespid',
        db_column='spid',
        on_delete=models.CASCADE,
        primary_key=True)
    acc = models.ForeignKey(Species, verbose_name='accepted genus', related_name='aveaccid', on_delete=models.CASCADE)
    comment = models.TextField(null=True, blank=True)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)
...
class SpcImages(models.Model):
    ...
    family = models.ForeignKey(Family, db_column='family', related_name='avepoolspcfamily', on_delete=models.DO_NOTHING)
    ...
    user_id = models.ForeignKey(User, db_column='user_id',related_name='avepooluser_id', null=True, blank=True,on_delete=models.DO_NOTHING)
    approved_by = models.ForeignKey(User, db_column='approved_by', related_name='avepoolapproved_by', null=True, blank=True,on_delete=models.DO_NOTHING)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)
...
class Video(models.Model):
    pid = models.ForeignKey(Species, null=False, db_column='pid', related_name='avevideopid',on_delete=models.DO_NOTHING)
    binomial = models.CharField(max_length=500, null=True, blank=True)
    author = models.ForeignKey(Photographer, db_column='author', related_name='avevideoauthor', on_delete=models.DO_NOTHING)
    credit_to = models.CharField(max_length=100, null=True, blank=True)
    name = models.CharField(max_length=100, null=True, blank=True)
    status = models.CharField(max_length=10, default='TBD')
    quality = models.IntegerField(choices=QUALITY, default=3,)
    ...
    video_file_path = models.ImageField(upload_to='utils/images/photos', max_length=255, null=True, blank=True)
    family = models.ForeignKey(Family, db_column='family', related_name='avevideofamily', on_delete=models.DO_NOTHING)
    download_date = models.DateField(null=True, blank=True)
    user_id = models.ForeignKey(User, db_column='user_id',related_name='avevideouser_id', null=True, blank=True,on_delete=models.DO_NOTHING)
    approved_by = models.ForeignKey(User, db_column='approved_by', related_name='avevideoapproved_by', null=True, blank=True,on_delete=models.DO_NOTHING)
    created_date = models.DateTimeField(auto_now_add=True, null=True)
    modified_date = models.DateTimeField(auto_now=True, null=True)
...
class UploadFile(models.Model):
    pid        = models.ForeignKey(Species, null=True, blank=True, db_column='pid', related_name='avepid',on_delete=models.DO_NOTHING)
    author     = models.ForeignKey(Photographer, db_column='author', related_name='aveauthor', null=True, blank=True,on_delete=models.DO_NOTHING)
    user_id    = models.ForeignKey(User, db_column='user_id', related_name='aveuser_id', null=True, blank=True,on_delete=models.DO_NOTHING)
    ...
    image_file_path = models.ImageField(upload_to='images/', max_length=255, null=True, blank=True)
    image_file  = models.CharField(max_length=100, null=True, blank=True)

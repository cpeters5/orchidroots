# Generated by Django 4.2.14 on 2024-08-25 05:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orchidaceae', '0016_alter_accepted_gen'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='GenusStat',
            fields=[
                ('pid', models.OneToOneField(db_column='pid', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='orgenstat', serialize=False, to='orchidaceae.genus')),
        ...
        migrations.CreateModel(
            name='SpeciesStat',
            fields=[
                ('pid', models.OneToOneField(db_column='pid', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='orspstat', serialize=False, to='orchidaceae.species')),

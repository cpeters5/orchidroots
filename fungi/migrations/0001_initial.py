    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(blank=True, db_column='family', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funfamily', to='common.family')),
                ('subfamily', models.ForeignKey(blank=True, db_column='subfamily', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funsubfamily', to='common.subfamily')),
                ('subtribe', models.ForeignKey(blank=True, db_column='subtribe', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funsubtribe', to='common.subtribe')),
                ('tribe', models.ForeignKey(blank=True, db_column='tribe', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funtribe', to='common.tribe')),
            ],
            options={
                'ordering': ('genus',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_edible', models.BooleanField(default=False, null=True)),
                ('is_parasitic', models.BooleanField(default=False, null=True)),
                ...
                ('family', models.ForeignKey(db_column='family', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='spcfunfamily', to='common.family')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_date', models.DateTimeField(auto_now=True, null=True)),
                ('approved_by', models.ForeignKey(blank=True, db_column='approved_by', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funvideoapproved_by', to=settings.AUTH_USER_MODEL)),
                ('author', models.ForeignKey(db_column='author', on_delete=django.db.models.deletion.DO_NOTHING, related_name='funvideoauthor', to='accounts.photographer')),
                ('family', models.ForeignKey(db_column='family', on_delete=django.db.models.deletion.DO_NOTHING, related_name='funvideofamily', to='common.family')),
                ('pid', models.ForeignKey(db_column='pid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='funvideopid', to='fungi.species')),
                ('user_id', models.ForeignKey(blank=True, db_column='user_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='funvideouser_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UploadFile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(db_column='family', on_delete=django.db.models.deletion.DO_NOTHING, related_name='funpoolspcfamily', to='common.family')),
                ('gen', models.ForeignKey(blank=True, db_column='gen', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='poolspcgen', to='fungi.genus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dist', models.ForeignKey(db_column='dist', default='', on_delete=django.db.models.deletion.DO_NOTHING, to='fungi.location')),
                ('pid', models.ForeignKey(db_column='pid', default='', on_delete=django.db.models.deletion.DO_NOTHING, related_name='fundist_pid', to='fungi.species')),
            ],
            options={
